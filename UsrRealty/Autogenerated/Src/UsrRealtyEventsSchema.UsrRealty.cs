namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("0eabc799-91e4-45d5-8442-1949e475c945");
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("ac8b0928-90e2-a18e-40e8-d3d462391ad1"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("6bb44093-5b0f-4bc5-bd4b-558d18a43202"),
				CreatedInSchemaUId = new Guid("0eabc799-91e4-45d5-8442-1949e475c945"),
				ModifiedInSchemaUId = new Guid("0eabc799-91e4-45d5-8442-1949e475c945")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("0eabc799-91e4-45d5-8442-1949e475c945"));
		}
